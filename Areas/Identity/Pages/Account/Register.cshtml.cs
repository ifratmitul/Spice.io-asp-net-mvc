        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(SD.KitcherUser))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(SD.KitcherUser));
                    }


                    if (role == SD.KitcherUser)
                    {
                        await _userManager.AddToRoleAsync(user, SD.KitcherUser);
                    }
